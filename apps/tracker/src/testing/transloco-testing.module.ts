  ...
  return TranslocoTestingModule.forRoot({
    langs: {
      en: {
        ...
        'browser.translationEditor.keyPatternError': 'Use letters, numbers, hyphens and underscores only',
        ...
        'collections.addButton': 'Add collection',
        'collections.subtitleX': '{ count, plural, =1 {1 collection} other {{count} collections} }',
        'collections.bundlesCountX': '{ count, plural, =1 {1 bundle} other {{count} bundles} }',
        'collections.card.baseLocaleLabel': 'base',
        'bundles.title': 'Output Bundles',
        'bundles.generateAll': 'Generate all',
        'bundles.generatingProgressX': '{current} of {total}…',
        'bundles.addButton': 'Add bundle',
        'bundles.deleteConfirmTitle': 'Delete Bundle',
        'bundles.deleteConfirmMessageX': 'Delete the bundle {name}? Files it already generated are kept.',
        'bundles.empty.title': 'No bundles yet',
        'bundles.empty.message':
          'A bundle combines collections into the per-locale JSON files your app loads with Transloco, and can emit typed key constants alongside them.',
        'bundles.empty.cta': 'Create bundle',
        'bundles.card.collectionsLabel': 'Collections',
        'bundles.card.allCollectionsX': 'All collections ({count})',
        'bundles.card.typesLabel': 'Types',
        'bundles.card.typesOff': 'off',
        'bundles.card.localesCountX': '{ count, plural, =1 {1 locale} other {{count} locales} }',
        'bundles.card.generate': 'Generate',
        'bundles.card.generating': 'Generating…',
        'bundles.card.generateAriaLabelX': 'Generate bundle {name}',
        'bundles.card.moreActionsAriaLabel': 'More actions for bundle',
        'bundles.card.outputLabel': 'Output',
        'bundles.run.generating': 'Generating',
        'bundles.run.writing': 'writing',
        'bundles.run.localesProgressX': '{current} of {total} locales',
        'bundles.run.generated': 'Generated',
        'bundles.run.filesX': '{ count, plural, =1 {1 file} other {{count} files} }',
        'bundles.run.keysPerLocaleX': '{count} keys per locale',
        'bundles.run.warningsX': '{ count, plural, =1 {1 warning} other {{count} warnings} }',
        'bundles.run.details': 'Details',
        'bundles.run.detailsAriaLabelX': 'Details of the last run of bundle {name}',
        'bundles.run.filesWritten': 'Files written',
        'bundles.run.keysX': '{ count, plural, =1 {1 key} other {{count} keys} }',
        'bundles.run.typesFile': 'Types file',
        'bundles.run.warningsHeading': 'Warnings',
        'bundles.run.failed': 'Generation failed',
        'bundles.run.dismissAriaLabelX': 'Dismiss the last run result for bundle {{ name }}',
        'bundles.toast.created': 'Bundle created successfully',
        'bundles.toast.updated': 'Bundle updated successfully',
        'bundles.toast.deleted': 'Bundle deleted successfully',
        'bundles.toast.error': 'Bundle not found. Reload the page and try again.',
        ...
        'header.goToCollections': 'Go to Collections',
        'header.backToCollections': 'Back to Collections',
        'locale.currentLanguage': 'Current language: {{ language }}',
        'locale.selectLanguage': 'Select language',
        'settings.title': 'Settings',
        'theme.light': 'Light',
        'theme.dark': 'Dark',
        'theme.system': 'System',
        'theme.settings': 'Theme settings',
        'theme.currentThemeX': 'Theme: {{ theme }}',
      },
    },
    translocoConfig: {
      availableLangs: ['en'],
